...
def run_daily(daily=None, komoditas_ids=None):

    if not daily:
        daily = today()

    df_raw = extract_daily(daily, komoditas_ids=komoditas_ids)
...
def run(start_date=None, end_date=None, komoditas_ids=None):
